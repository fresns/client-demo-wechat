...
function e(t) {
    for (var i = t.length - 1, e = i; e >= -1; e--)
        (-1 === e ||
            ...
            (i - e >= 5 && t.splice(e + 1, i - e, { name: 'div', attrs: {}, children: t.slice(e + 1, i + 1) }),
            (i = e - 1));
}
function s(t) {
    (this.options = t.data || {}),
...
(s.prototype.parse = function (t) {
    ...
    (s.prototype.parseStyle = function (t) {
        ...
        i.id &&
            ...
            i.height &&
                ((s.height = parseFloat(i.height) + (i.height.includes('%') ? '%' : 'px')), (i.height = void 0));
        ...
        if (
            ...
            if ('img' === i.name) {
                ...
                'inline' === c.display && (c.display = ''),
                    e.ignore &&
                        ((c['max-width'] = c['max-width'] || '100%'), (e.style += ';-webkit-touch-callout:none')),
    ...
    (s.prototype.popNode = function () {
        ...
        if (
            ...
            'table' !== t.name &&
                parseInt(d.width) > h &&
                ((d['max-width'] = '100%'), (d['box-sizing'] = 'border-box')),
            n.blockTags[t.name])
        )
            t.name = 'div';
                                ...
                                if ('td' === O.name || 'th' === O.name) {
                                    ...
                                    if (
                                        ...
                                        O.attrs.colspan &&
                                            ...
                                            O.attrs.rowspan ||
                                                (C += ';grid-row-start:'.concat(k, ';grid-row-end:').concat(k + 1)),
                                            (N += parseInt(O.attrs.colspan) - 1)),
                                        O.attrs.rowspan)
                                    ) {
                                        (C += ';grid-row-start:'
                                            .concat(k, ';grid-row-end:')
                                            .concat(k + parseInt(O.attrs.rowspan))),
                                            O.attrs.colspan ||
                                                (C += ';grid-column-start:'
                                                    .concat(N, ';grid-column-end:')
                                                    .concat(N + 1));
