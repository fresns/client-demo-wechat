...
Page({
  ...
  onLoad: async function (options) {
    let requestState = await fresnsConfig('channel_user_query_state');
    let requestQuery = parseUrlParams(await fresnsConfig('channel_user_query_config'));
    ...
    this.setData({
      title: await fresnsConfig('channel_user_name'),
