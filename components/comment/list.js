    ...
    methods: {
        ...
        onClickMoreMenu: async function (e) {
            ...
            if (comment.followSetting) {
                marks.push({
                    text: comment.followStatus ? '已' + comment.followName : comment.followName,
                    value: '_onClickCommentFollow',
                });
            }
            if (comment.blockSetting) {
                marks.push({
                    text: comment.blockStatus ? '已' + comment.blockName : comment.blockName,
                    value: '_onClickCommentBlock',
                });
            }
            this.setData({
                showMoreMenu,
