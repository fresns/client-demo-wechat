    ...
    methods: {
        ...
        onClickContentMore: async function (e) {
            ...
            if (post.followSetting) {
                marks.push({
                    text: post.followStatus ? '已' + post.followName : post.followName,
                    value: '_onClickPostFollow',
                });
            }
            if (post.blockSetting) {
                marks.push({
                    text: post.blockStatus ? '已' + post.blockName : post.blockName,
                    value: '_onClickPostBlock',
                });
            }
            this.setData({
